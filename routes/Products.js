...
import {loadCategory, insertProducts, viewAllProducts, viewProductsCategory, busquedaProductos, modificProduct, eliminarProducto} from './../controllers/FunctionsProductos.js'
...
router.get("/cargarCategorias/:adminId", async (req, res) => {
